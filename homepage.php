 ...
 <div class="intro">
  ...
  <section class="section">
    ...
    <div class="ac-center box">
      <div class="ac">
        <div class="img-cover">
          <img src="images/products/expe-bag.png" alt="" />
        </div>
      ...
      <div class="ac">
        <div class="img-cover">
          <img src="images/products/leather-sandals.png" alt="" />
        </div>
      ...
      <div class="ac">
        <div class="img-cover">
          <img src="images/products/ladies-wallet-purple.png" alt="" />
        </div>
      ...
      <div class="ac">
        <div class="img-cover">
          <img src="images/products/belt.png" alt="" />
        </div>
        <p>Leather belt</p>
        <div class="rating">
          <i class="bx bxs-star"></i>
  ...
  <section class="section">
    ...
    <div class="ab box">
      ...
      <div class="item item-2">
        <img src="images/products/ladies shoes.png" alt="" />
      </div>
      <div class="item item-3">
        <img src="images/products/sock2.png" alt="" />
      </div>
      <div class="item item-4">
        <img src="images/products/men boots.png" alt="" />
      </div>
    </div>
  </section>
  ...
  <section class="section">
    ...
    <div class="ac-center box">
      ...
      <div class="ac">
        <div class="img-cover">
          <img src="images/products/fanny-pack.png" alt="" />
        </div>
        <p>Cute Wallet</p>
        <div class="rating">
          <i class="bx bxs-star"></i>
      ...
      <div class="ac">
        <div class="img-cover">
          <img src="images/products/shoe10.png" alt="" />
        </div>
        <p>Black Sandals</p>
        <div class="rating">
          <i class="bx bxs-star"></i>
      ...
      <div class="ac">
        <div class="img-cover">
          <img src="images/products/small bag .png" alt="" />
        </div>
      ...
      <div class="ac">
        <div class="img-cover">
          <img src="images/products/ladies bags .png" alt="" />
        </div>
